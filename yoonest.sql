...
--
-- Host: localhost    Database: yoonest
-- ------------------------------------------------------
...
INSERT INTO `customers` VALUES (1,'john.down@yoonest.com','John','Dow'),(2,'walter.white@yoonest.com','Walter','White'),(3,'john.snow@yoonest.com','John','Snow');
...
CREATE TABLE `orders` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `customer` bigint(20) unsigned DEFAULT 0,
  `status` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'publish',
